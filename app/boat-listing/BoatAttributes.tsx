...
import { Age, BoatUsage, Condition, Length, SellerType, Variant, Warranty, Year } from '@/constants/Data';
...
const Page = () => {
    const { boatCategory, type } = useLocalSearchParams();
    ...
    const onSubmit = async (data: any) => {
        ...
        setTimeout(() => {
            router.push({
                pathname: '/boat-listing/BoatSummary',
                params: {
        ...
        <View style={{ flex: 1, backgroundColor: theme.backgroundColor2 }}>
            ...
            >
                <View style={{
                    ...
                    <View style={{ marginTop: heightPercentageToDP(2) }}>
                        <Text style={[mainStyle.inputLabel, { color: theme.sub }]}>Age</Text>
                        <Controller
                            control={control}
                            rules={{
                                required: true,
                    ...
                    <View style={{ marginTop: heightPercentageToDP(2) }}>
                        <Text style={[mainStyle.inputLabel, { color: theme.sub }]}>Condition</Text>
                        <Controller
                            control={control}
                            rules={{
                                required: true,
                    ...
                    <View style={{ marginTop: heightPercentageToDP(2) }}>
                        <Text style={[mainStyle.inputLabel, { color: theme.sub }]}>Length</Text>
                        <Controller
                            control={control}
                            rules={{
                                required: true,
